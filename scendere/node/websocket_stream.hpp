...
#include <scendere/boost/beast/core.hpp>
#include <scendere/boost/beast/websocket.hpp>
...
namespace scendere::websocket
{
/** The minimal stream interface needed by the Scendere websocket implementation */
...
public:
	...
	virtual void async_write (scendere::shared_const_buffer const & buffer_a, std::function<void (boost::system::error_code, std::size_t)> callback_a) = 0;
