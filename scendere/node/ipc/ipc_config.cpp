...
scendere::error scendere::ipc::ipc_config::serialize_toml (scendere::tomlconfig & toml) const
{
	scendere::tomlconfig tcp_l;
	...
	scendere::tomlconfig flatbuffers_l;
...
scendere::error scendere::ipc::ipc_config::deserialize_toml (scendere::tomlconfig & toml)
{
