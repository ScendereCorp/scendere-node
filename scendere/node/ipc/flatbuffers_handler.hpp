...
namespace ipc
{
	 ...
	 * @throws Methods of this class throw scendere::error on failure.
	...
	public:
		 ...
		 */
		flatbuffers_handler (scendere::node & node_a, scendere::ipc::ipc_server & ipc_server_a, std::shared_ptr<scendere::ipc::subscriber> const & subscriber_a, scendere::ipc::ipc_config const & ipc_config_a);
		 ...
		 */
		static std::shared_ptr<flatbuffers::Parser> make_flatbuffers_parser (scendere::ipc::ipc_config const & ipc_config_a);
	...
	private:
		...
		scendere::ipc::ipc_config const & ipc_config;
	};
}
}
