...
std::vector<std::string> scendere::config_overrides (std::vector<config_key_value_pair> const & key_value_pairs_a)
{
...
std::istream & scendere::operator>> (std::istream & is, scendere::config_key_value_pair & into)
{
	char ch;
	while (is >> ch && ch != '=')
	{
