...
scendere::error scendere::diagnostics_config::serialize_toml (scendere::tomlconfig & toml) const
{
	scendere::tomlconfig txn_tracking_l;
...
scendere::error scendere::diagnostics_config::deserialize_toml (scendere::tomlconfig & toml)
{
