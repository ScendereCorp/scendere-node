...
scendere::error scendere::rocksdb_config::serialize_toml (scendere::tomlconfig & toml) const
{
...
scendere::error scendere::rocksdb_config::deserialize_toml (scendere::tomlconfig & toml)
{
...
bool scendere::rocksdb_config::using_rocksdb_in_tests ()
{
