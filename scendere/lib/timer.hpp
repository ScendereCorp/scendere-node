...
public:
	timer () = default;
	timer (scendere::timer_state state_a, std::string const & description_a = "timer");
	...
	scendere::timer_state current_state () const;

private:
	timer * parent{ nullptr };
	std::vector<timer> children;
	scendere::timer_state state{ scendere::timer_state::stopped };
	std::string desc;
