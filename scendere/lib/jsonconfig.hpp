...
class jsonconfig : public scendere::configbase
{
public:
	jsonconfig ();
	jsonconfig (boost::property_tree::ptree & tree_a, std::shared_ptr<scendere::error> const & error_a = nullptr);
	...
	jsonconfig & put_child (std::string const & key_a, scendere::jsonconfig & conf_a);
	jsonconfig & replace_child (std::string const & key_a, scendere::jsonconfig & conf_a);
