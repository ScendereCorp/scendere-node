...
namespace ipc
{
	/** Produces Scendere API compliant Flatbuffers from objects and builders */
	...
	public:
		...
		{
			scendere::ipc::flatbuffer_producer producer;
		...
		auto make_envelope (flatbuffers::Offset<T> obj)
		{
			...
			scendereapi::EnvelopeBuilder envelope_builder (*fbb);
			...
			envelope_builder.add_message_type (scendereapi::MessageTraits<T>::enum_value);
