...
inline double to_multiplier (scendere_pow_server::u128 const difficulty_a, scendere_pow_server::u128 const base_difficulty_a)
{
...
inline scendere_pow_server::u128 from_multiplier (double const multiplier_a, scendere_pow_server::u128 const base_difficulty_a)
{
