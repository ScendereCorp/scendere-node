...
class cliArgs():
    def __init__(self):
        ...
        parse.add_argument(
            ...
            default='scenderecurrency/scendere-node',
        )
        parse.add_argument(
            '-s', '--start',
...
class generateMarkdown():
    ...
    def __init__(self, repo):
        ...
        self.mdFile.new_line(
            "## Release " +
            "[{0}](https://github.com/scenderecurrency/scendere-node/tree/{0})".format(repo.end), wrap_width=0)
        self.mdFile.new_line("[Full Changelog](https://github.com/scenderecurrency"
                             "/scendere-node/compare/{0}...{1})".format(repo.start, repo.end), wrap_width=0)
